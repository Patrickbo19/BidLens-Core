...
const schemas = {
  ...
  apxAttempt:{ type:'object', required:['job_id','target_url','goal','delivery_issue_url'], properties:{ job_id:{ type:'string', minLength:8, maxLength:120 }, target_url:{ type:'string', format:'uri' }, goal:{ type:'string', minLength:10, maxLength:4000 }, delivery_issue_url:{ type:'string', format:'uri' }, constraints:{ type:'string', maxLength:4000 } }, additionalProperties:false },
};
const examples = {
  ...
  apxAttempt:{ job_id:'job_example_001', target_url:'https://github.com/example/project/issues/123', goal:'Produce the strongest submission-ready solution you can for this public task.', delivery_issue_url:'https://github.com/example/project/issues/123', constraints:'Use only public information. Do not spend funds or accept legal terms.' },
};
const outputs = {
  ...
  apxAttemptAccepted:{ ok:true, status:'accepted', jobId:'job_example_001', delivery:'github-comment', service:'APX Chat Work Attempt', note:'A ChatGPT worker will inspect the public target and post a best-effort deliverable to the supplied GitHub issue/PR. Payment buys the work attempt, not a guaranteed bounty win or downstream payout.' },
};
